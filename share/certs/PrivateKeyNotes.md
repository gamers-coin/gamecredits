...
unlocked to sign the GameCredits-Qt.app bundle.
...
allowing somebody to distribute a GameCredits-Qt.app or gamecredits-qt-setup.exe with a valid
...
that the gamecredits-qt.exe file inside the installer had not been tampered with.
