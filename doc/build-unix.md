...
This will build gamecredits-qt as well if the dependencies are met.
...
If you want to build GameCredits-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a gamecredits-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip gamecreditsd" to strip the debug
