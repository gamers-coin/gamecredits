...
static bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock, true, NULL))
        return error("GameCreditsMiner: ProcessNewBlock, block not accepted");
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try {
        while (true) {
            ...
            if (!pblocktemplate.get())
            {
                LogPrintf("Error in GameCreditsMiner: Keypool ran out, please call keypoolrefill before restarting the mining thread\n");
                return;
            }
    ...
    {
        LogPrintf("GameCreditsMiner runtime error: %s\n", e.what());
        return;
    }
}
