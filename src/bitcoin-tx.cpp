...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GameCredits Core gamecredits-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gamecredits-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamecredits transaction") + "\n" +
              "  gamecedits-tx [options] -create [commands]   " + _("Create hex-encoded gamecredits transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GameCredits transaction
