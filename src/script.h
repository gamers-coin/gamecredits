...
#ifndef H_GAMECREDITS_SCRIPT
#define H_GAMECREDITS_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CGamecreditsAddress
 */
...
public:
    ...
    // Pre-version-0.6, Gamecredits always counted CHECKMULTISIGs
