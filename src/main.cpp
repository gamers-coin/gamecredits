 ...
 */
static bool IsSuperMajority(int minVersion, const CBlockIndex* pstart, unsigned nRequired, unsigned int nToCheck);
...
void CheckForkWarningConditions()
{
    ...
    // If our best fork is no longer within 180 blocks
    // of our head, drop it
...
void CheckForkWarningConditionsOnNewFork(CBlockIndex* pindexNewForkTip)
{
    ...
    // with a tip within 180 blocks of ours
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Check proof of work after last checkpoint
    if ((nHeight > Checkpoints::GetTotalBlocksEstimate(chainParams.Checkpoints())))  {
