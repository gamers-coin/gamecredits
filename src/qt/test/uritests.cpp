...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseGamecreditsURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseGamecreditsURI("gamecredits://bGfikGxWjawwxnBQSsinRZXFFQNSoudzk8?message=Gamecredits Example Address", &rv));
    QVERIFY(rv.address == QString("bGfikGxWjawwxnBQSsinRZXFFQNSoudzk8"));
    QVERIFY(rv.label == QString());
