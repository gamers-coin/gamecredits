...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "GameCredits",
    ...
    QApplication::setOrganizationName("GameCredits");
    QApplication::setOrganizationDomain("gamecredits.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("GameCredits-Qt-testnet");
    else
        QApplication::setApplicationName("GameCredits-Qt");
